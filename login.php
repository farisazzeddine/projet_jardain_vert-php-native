...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="blog jadin vert, jardinage">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- The above 4 meta tags *must* come first in the head; any other head content must come *after* these tags -->

    <!-- Title -->
    <title>Login Le jardin vert blog</title>
                ...
                <div class="col-12 col-lg-6">
                    <div class="login-content bg-white p-30 box-shadow">
                        ...
                        <div class="section-heading">
                            <h5 class="text-center">Great to have you back! <br> WELCOME  <?php
                        ...
                        ?>
                            <form method="post" action="loginCode.php">
                                       ...
                                       <input class="form-control" name="pass" type="password" placeholder="Password">
                                        ...
                                        <span class="text-danger">Or <a href="submit.php" class="text-success">new user</a></span>
                                        </div>
                            </form>
                    ...
                    <?php if (isset($_SESSION['uname'])) {
                        ...
                        <form method="get" action="logout.php">
                         <button href="logout.php?logout=1" class="btn btn-primary"   type="submit" name="logou"> log-Out</button> 
                       </form>
                         <?php
                    }
                    ?>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="footer-widget">
                        <!-- Logo -->
                        <a href="index.php" class="nav-brand"><img src="img/green leaves.png" width="60" alt="Le jardin Vert "><span style="color:#a7c94d; font-size:2em; font-weight: bolder;">Le jardin Vert</span></a>
